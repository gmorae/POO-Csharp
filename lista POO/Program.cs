...
namespace lista_POO
{
    class Program
    {
        ...
        {
            int opcao;
            FuncionarioModels func = new FuncionarioModels();
            List<FuncionarioModels> listaFuncionarios = new List<FuncionarioModels>();
            ...
            do
            {
                ...
                switch (opcao)
                {
                    case 1:
                        ...
                        FuncionarioModels funcionarioCadastrados =  func.CadastrarFuncionario();
                        listaFuncionarios.Add(funcionarioCadastrados);
